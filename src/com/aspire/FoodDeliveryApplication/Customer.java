...
//	            total += rating;
//	        }
//	        return ratings.isEmpty() ? 0 : (double) total / ratings.size();
//	    }
//
...
//	        String query = "INSERT INTO restaurant_owner (restaurant_name, name, email, phone_number) VALUES (?, ?, ?, ?)";
//	        PreparedStatement stmt = conn.prepareStatement(query);
...
//	    private double price;
//
//	    public MenuItems(int id, String name, String description, double price) {
//	        this.id = id;
//	        this.name = name;
//	        this.description = description;
//	        this.price = price;
...
//
//	public class FoodDelivery {
//	    // Predefined locations and restaurants
//	    private static final Map<String, List<String>> restaurantsByLocation = new HashMap<>();
//	    private static final Map<String, List<String>> menuByRestaurant = new HashMap<>();
//
//	    static {
//	        // Predefine some restaurants in various locations
//	        restaurantsByLocation.put("New York", Arrays.asList("Pizza Palace", "Burger King"));
//	        restaurantsByLocation.put("Los Angeles", Arrays.asList("Taco Bell", "Pasta Mania"));
//	        restaurantsByLocation.put("San Francisco", Arrays.asList("Sushi World", "Burger Joint"));
//	        restaurantsByLocation.put("Chicago", Arrays.asList("Deep Dish Pizza", "Vegan Delight"));
//
//	        // Predefine menus for each restaurant
//	        menuByRestaurant.put("Pizza Palace", Arrays.asList("Pizza - $10.00", "Burger - $8.00", "Pasta - $12.00"));
//	        menuByRestaurant.put("Burger King", Arrays.asList("Cheeseburger - $6.00", "Chicken Fries - $4.00", "Milkshake - $3.00"));
//	        menuByRestaurant.put("Taco Bell", Arrays.asList("Tacos - $5.00", "Burritos - $7.00", "Quesadilla - $6.00"));
//	        menuByRestaurant.put("Pasta Mania", Arrays.asList("Spaghetti - $8.00", "Mac & Cheese - $7.00", "Lasagna - $10.00"));
//	        // Add more restaurants and menu items as needed
//	    }
//
//	    public static void main(String[] args) {
//	        
...
//
//public class FoodDelivery {
//    // Predefined locations and restaurants (optional if you want to extend it)
//    private static final Map<String, List<String>> restaurantsByLocation = new HashMap<>();
//    
//    public static void main(String[] args) {
//        try {
